...
namespace _2212462_TH_BTVN
{
    public partial class Form1 : Form
    {
        ...
        private void truongCongThanhToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            if (textBox1.Text.ToString() == "Thanh" && textBox2.Text.ToString() == "123")
            {
